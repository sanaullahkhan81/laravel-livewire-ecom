                ...
                @forelse($cartItems  as $index => $item)
                    <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5" wire:key="cart-item-{{ $index }}">
                        ...
                        <div class="flex justify-center w-1/5">
                            <svg wire:click="decrementQuantity({{ $item['id'] }})" class="cursor-pointer fill-current text-gray-600 w-3" viewBox="0 0 448 512"><path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/>
                            </svg>
                            <label>
                                <input class="mx-2 border text-center w-10" type="text" value="{{$item['quantity']}}" disabled>
                            </label>
                            <svg wire:click="incrementQuantity({{ $item['id'] }})" class="cursor-pointer fill-current text-gray-600 w-3" viewBox="0 0 448 512">
